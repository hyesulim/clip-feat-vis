...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0,
        help="soft constraint for orthogonal gap",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="coefficient for smoothing logits in the self-dist loss computation",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default='',
        help="distillation loss schedule type (default: constant without schedule)",
    )
