...
def parse_args():
    ...
    parser.add_argument(
        "--root_data",
        type=str,
        default="/home/nas2_userH/hyesulim/Data",
        help="Root path for the data",
    )
    parser.add_argument(
        "--root_code",
        type=str,
        default="/home/nas2_userH/hyesulim/Dev/2023/11785-f23-prj",
    ...
    parser.add_argument("--obj", type=str, default="layer1_2_relu3", help="Objective")
    parser.add_argument("--batch_size", type=int, default=256, help="Batch size")
    parser.add_argument(
        "--subset_samples", type=int, default=10000, help="Number of subset samples"
    )
    parser.add_argument("--train", type=bool, default=True, help="Training mode")
    parser.add_argument(
        "--ckpt_dir", type=str, default=None, help="Test model checkpoint directory"
    )
    parser.add_argument(
        "--model_arch", type=str, default="RN50", help="CLIP model architecture"
    )
